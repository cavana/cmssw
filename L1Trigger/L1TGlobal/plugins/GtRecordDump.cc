...
namespace l1t {
  ...
  cms_uint64_t GtRecordDump::formatMuon(std::vector<l1t::Muon>::const_iterator mu) {
	...
	std::cout << "----------------------" << std::endl;
	std::cout << "<<  0; mu->hwPhiAtVtx()        = " << std::hex << std::setw(16) << std::setfill('0') << ((cms_uint64_t)(mu->hwPhiAtVtx() & 0x3ff) << 0)  << std::endl;
	std::cout << "<< 10; mu->hwPt()              = " << std::hex << std::setw(16) << std::setfill('0') << ((cms_uint64_t)(mu->hwPt() & 0x1ff) << 10) << std::endl;
	std::cout << "<< 19; mu->hwQual()            = " << std::hex << std::setw(16) << std::setfill('0') << ((cms_uint64_t)(mu->hwQual() & 0xf) << 19) << std::endl;
	std::cout << "<< 23; mu->hwEtaAtVtx()        = " << std::hex << std::setw(16) << std::setfill('0') << ((cms_uint64_t)(mu->hwEtaAtVtx() & 0x1ff) << 23)  << std::endl;
	std::cout << "<< 32; mu->hwIso()             = " << std::hex << std::setw(16) << std::setfill('0') << ((cms_uint64_t)(mu->hwIso() & 0x3) << 32) << std::endl;
	std::cout << "<< 34; mu->hwCharge()          = " << std::hex << std::setw(16) << std::setfill('0') << ((cms_uint64_t)(mu->hwCharge() & 0x1) << 34) << std::endl;
	std::cout << "<< 35; mu->hwChargeValid()     = " << std::hex << std::setw(16) << std::setfill('0') << ((cms_uint64_t)(mu->hwChargeValid() & 0x1) << 35) << std::endl;
	std::cout << "<< 43; mu->hwPhi()             = " << std::hex << std::setw(16) << std::setfill('0') << ((cms_uint64_t)(mu->hwPhi() & 0x3ff) << 43) << std::endl;
	std::cout << "<< 53; mu->hwPtUnconstrained() = " << std::hex << std::setw(16) << std::setfill('0') << ((cms_uint64_t)(mu->hwPtUnconstrained() & 0xff)  << 53) << std::endl;
	std::cout << "<< 62; mu->hwDXY()             = " << std::hex << std::setw(16) << std::setfill('0') << ((cms_uint64_t)(mu->hwDXY() & 0x3) << 62) << std::endl;
	std::cout << "packedWord                     = " << std::hex << std::setw(16) << std::setfill('0') << packedVal  << std::endl;
	std::cout << "----------------------" << std::endl;
      }
